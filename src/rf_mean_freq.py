...
if __name__ == '__main__':
    ...
    # importing the data
    data1 = pd.read_csv("datasets/df_intra_ljspeech_mean_q1.csv")
    data2 = pd.read_csv("datasets/df_intra_ljspeech_mean_q2.csv")
    data3 = pd.read_csv("datasets/df_intra_ljspeech_mean_q3.csv")
    data4 = pd.read_csv("datasets/df_intra_ljspeech_mean_q4.csv")
